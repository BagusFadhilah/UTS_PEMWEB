...
class FoodController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajay()) {
            ...
            $table->editColumn('mobil', function ($row) {
                return $row->mobil ? $row->mobil : '';
            });
            $table->editColumn('plat_nomor', function ($row) {
                return $row->plat_nomor ? $row->plat_nomor : '';
            });
    ...
    public function edit(Supir $supir)
    {
        ...
        return view('admin.supirs.edit', compact('food'));
    }
